  ...
  describe('Entity Validation Schemas', () => {
    ...
    describe('PaginationRequestSchema', () => {
      test('should validate valid pagination request', () => {
        ...
        expect(() => PaginationRequestSchema.parse(validPagination)).not.toThrow();
      });
  ...
  describe('Validation Utilities', () => {
    ...
    describe('SchemaUtils', () => {
      ...
      test('should create pick schema', () => {
        ...
        const result = pickSchema.parse({ name: 'Test', email: 'test@example.com' });
      ...
      test('should create omit schema', () => {
        ...
        const result = omitSchema.parse({ name: 'Test', email: 'test@example.com' });
      ...
      test('should extend schema', () => {
        ...
        const extendedSchema = SchemaUtils.extend(baseSchema, { age: z.number() });
    ...
    describe('CommonValidation', () => {
      ...
      test('should work with all validation patterns', () => {
        ...
        expect(() => CommonValidation.email.parse(testData.email)).not.toThrow();
        expect(() => CommonValidation.phone.parse(testData.phone)).not.toThrow();
        expect(() => CommonValidation.password.parse(testData.password)).not.toThrow();
        expect(() => CommonValidation.name.parse(testData.name)).not.toThrow();
        expect(() => CommonValidation.text.parse(testData.text)).not.toThrow();
        expect(() => CommonValidation.shortText.parse(testData.shortText)).not.toThrow();
        expect(() => CommonValidation.url.parse(testData.url)).not.toThrow();
        expect(() => CommonValidation.dateString.parse(testData.dateString)).not.toThrow();
        expect(() => CommonValidation.dateTimeString.parse(testData.dateTimeString)).not.toThrow();
        expect(() => CommonValidation.slug.parse(testData.slug)).not.toThrow();
        expect(() => CommonValidation.metadata.parse(testData.metadata)).not.toThrow();
      });
    });
  });
});