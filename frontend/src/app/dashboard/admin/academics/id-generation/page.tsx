                    ...
                    {!generationType ? (
                      ...
                      <div className='bg-white p-4 rounded-lg shadow space-y-4'>
                        ...
                        <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
                              ...
                              <div className='flex items-center'>
                                ...
                                <div className='ml-3'>
                                  ...
                                  <p className='text-sm text-yellow-700 mt-1'>
                                    ...
                                    template before generating ID cards. Use the
                                    Template Builder tab to create your first
                                    template.
                                  </p>
                                </div>
                              </div>
                          ...
                          <Card
                            className={`p-6 transition-all border border-gray-200 ${
                              isLoading || templates.length === 0
                                ? 'opacity-60 cursor-not-allowed'
                                : 'hover:shadow-lg cursor-pointer hover:border-blue-300 hover:bg-blue-50'
                            }`}
                            onClick={() => {
                          ...
                          >
                            <div className='text-center space-y-4'>
                              ...
                              <Button
                                ...
                                className='w-full bg-blue-600 hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 text-white font-medium py-2.5 px-4 rounded-md transition-all duration-200 shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-blue-600'
                                size='default'
                              >
                                {templates.length === 0
                                  ? 'No Templates Available'
                          ...
                          <Card
                            className={`p-6 transition-all border border-gray-200 ${
                              isLoading || templates.length === 0
                                ? 'opacity-60 cursor-not-allowed'
                                : 'hover:shadow-lg cursor-pointer hover:border-green-300 hover:bg-green-50'
                            }`}
                            onClick={() => {
                              if (!isLoading && templates.length > 0) {
                          ...
                          >
                            <div className='text-center space-y-4'>
                              ...
                              <Button
                                disabled={isLoading || templates.length === 0}
                                className='w-full bg-green-600 hover:bg-green-700 focus:ring-2 focus:ring-green-500 focus:ring-offset-2 text-white font-medium py-2.5 px-4 rounded-md transition-all duration-200 shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-green-600'
                                size='default'
                              >
                                {templates.length === 0
                                  ? 'No Templates Available'
                  ...
                  <div className='bg-white p-4 rounded-lg shadow space-y-6'>
                    <div className='flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4'>
                      ...
                      <div className='flex flex-col sm:flex-row gap-3'>
                        <Button
                          variant='outline'
                          className='flex items-center justify-center gap-2 border-gray-300 text-gray-700 hover:bg-gray-50 hover:border-gray-400 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 font-medium py-2 px-4 rounded-md transition-all duration-200'
                          size='default'
                        >
                        ...
                        <Button
                          ...
                          disabled={isLoading}
                          className='flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 text-white font-medium py-2 px-4 rounded-md transition-all duration-200 shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-blue-600'
                          size='default'
                        >
