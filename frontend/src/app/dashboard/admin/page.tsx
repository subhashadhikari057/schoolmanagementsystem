  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="px-3 sm:px-4 lg:px-6 pt-2 sm:pt-3 lg:pt-4">
        ...
        <p className="text-xs sm:text-sm lg:text-base text-gray-600 mt-1">Welcome back! Here&apos;s your school overview.</p>
      </div>
      ...
      <div className="px-3 sm:px-4 lg:px-6 pb-4 sm:pb-6 lg:pb-8">
        <div className="max-w-7xl mx-auto space-y-4 sm:space-y-5 lg:space-y-6 mt-4 sm:mt-5 lg:mt-6">
          ...
          <div className="space-y-4">
            <h2 className="text-base sm:text-lg font-semibold text-gray-900 px-1">Analytics Overview</h2>
          ...
          <div className="space-y-3">
            <h2 className="text-base sm:text-lg font-semibold text-gray-900 px-1">System Status</h2>
