...
import RememberAndForgotRow from "@/components/molecules/RememberAndForgotRow";
import ReusableButton from "@/components/atoms/Button";
import LoginFooterSupportLink from "@/components/molecules/LoginFooterSupportLink";
...
export default function Form({
  ...
  titleClassName = "text-[2.07rem] font-semibold leading-[1.3]",           // Previously 'headingClassName'
  ...
  iconSize = "lg",
  buttonLabel = "Login",
  buttonClassName = "w-full h-10 mt-4 bg-[#515DEF] text-background cursor-pointer hover:bg-[#4141D9] transition-colors duration-200 ease-in-out hover:scale-101",  // UPDATED for better UX
  showRememberMe = true,
