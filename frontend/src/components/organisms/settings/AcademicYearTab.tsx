      ...
      <Card className='p-6 border border-gray-200 shadow-sm hover:shadow-md transition-shadow'>
        <div className='flex items-center gap-4 mb-8'>
          ...
          <div>
            ...
            <p className='text-gray-600 text-sm mt-1'>
              Set up the current academic year and calendar settings
            </p>
          </div>
        </div>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
          ...
          <InputGroup
            ...
            label='Total Academic Weeks'
            value={formData.totalAcademicWeeks}
            field='totalAcademicWeeks'
          ...
          <InputGroup
            ...
            label='Examination Weeks'
            value={formData.examinationWeeks}
            field='examinationWeeks'
            placeholder='Enter exam weeks'
            type='number'
            suffix='weeks'
          />
          ...
          <InputGroup
            ...
            label='Holiday Weeks'
            value={formData.holidayWeeks}
            field='holidayWeeks'
            placeholder='Enter holiday weeks'
            type='number'
            suffix='weeks'
          />
        </div>
          ...
          <div className='grid grid-cols-2 lg:grid-cols-4 gap-4'>
            ...
            <div className='text-center'>
              <div className='text-lg font-bold text-green-600'>
                {weeksSummary.teaching}
              </div>
              <div className='text-xs text-gray-600'>Teaching Weeks</div>
            </div>
            <div className='text-center'>
              <div className='text-lg font-bold text-orange-600'>
                {weeksSummary.exam}
              </div>
              <div className='text-xs text-gray-600'>Exam Weeks</div>
            </div>
            <div className='text-center'>
              <div className='text-lg font-bold text-cyan-600'>
                {weeksSummary.holiday}
              </div>
              <div className='text-xs text-gray-600'>Holiday Weeks</div>
            </div>
          </div>
        </div>
      </Card>
