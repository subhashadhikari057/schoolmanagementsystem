  ...
  return (
    <div className='space-y-6'>
      ...
      <div className='space-y-2'>
        ...
        <div className='grid grid-cols-2 grid-rows-2 sm:grid-cols-3 sm:grid-rows-2 md:grid-cols-3 md:grid-rows-1 gap-3 sm:gap-4 mt-2'>
          {quickReports.map((label, i) => (
            <div
              key={i}
              className='flex flex-col items-center justify-center p-4 bg-white rounded-lg border border-gray-200 cursor-pointer hover:shadow-md min-h-[80px]'
            >
              <span className='inline-block mb-1'>
                <FileText />
              </span>
              <span className='font-medium text-center block sm:hidden'>
                {label}
              </span>
              <span className='font-medium text-center hidden sm:block'>
                {label}
              </span>
            </div>
          ))}
      ...
      <div className='space-y-2'>
        ...
        <div className='space-y-4 mt-2'>
          {recentReports.map((r, i) => (
            <div
              key={i}
              className='flex flex-col gap-2 p-4 bg-white rounded-lg border border-gray-200 w-full'
            >
