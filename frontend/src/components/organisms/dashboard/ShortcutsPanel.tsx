...
import { UserPlus, Users, MessageSquare, Download, LucideIcon } from 'lucide-react';
...
export default function ShortcutsPanel({ 
  ...
  const shortcuts: ShortcutItem[] = [
    ...
    },
    {
      ...
      action: onDownloadBulkData || (() => console.log('Download Bulk Data clicked'))
    }
  ];

  return (
    <div className="rounded-xl p-3 sm:p-4">
      <SectionTitle text="Shortcuts" className="text-base sm:text-lg font-semibold text-gray-900 mb-3" />
