...
export default function QuickActionItems({quickActions}:{quickActions: QuickAction}) {
  return (
    <button
    ...
    >
      ...
      <span className="text-sm font-medium text-gray-700 text-center">{quickActions.title}</span>
    </button>
  )
}
