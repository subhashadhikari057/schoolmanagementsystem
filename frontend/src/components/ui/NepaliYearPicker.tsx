...
interface NepaliYearPickerProps {
  label?: string;
  value: string; // Format: "2082"
...
const NepaliYearPicker: React.FC<NepaliYearPickerProps> = ({
  label,
  value,
  onChange,
  disabled = false,
          ...
          <div className='p-2'>
            ...
            {generateYearOptions().map(year => {
              ...
              return (
                ...
                >
                  <div className='font-medium'>{year} BS</div>
                  <div className='text-xs opacity-75'>Academic Year {year}</div>
                </button>
              );
            })}
          </div>
...
export default NepaliYearPicker;
