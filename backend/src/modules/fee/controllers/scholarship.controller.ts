...
export class ScholarshipController {
  ...
  async assignToStudent(
    ...
    if (!dto.scholarshipId || !dto.studentId || !dto.effectiveFrom) {
      throw new BadRequestException(
        'Missing required fields: scholarshipId, studentId, effectiveFrom',
      );
    }
    ...
    return this.service.assignToStudent(dto);
  }
