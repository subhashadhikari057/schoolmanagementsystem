...
export class StaffImportController {
  ...
  @ApiOperation({ summary: 'Import staff from CSV file' })
  ...
  async importStaff(
    ...
    return await this.staffImportService.importStaffFromCSV(
      csvContent,
      user?.id || 'system',
      options,
    );
  ...
  @RoleAccess.AdminLevel()
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Export staff to CSV' })
  @ApiResponse({
    status: 200,
    description: 'CSV file with staff data',
    schema: {
  ...
  async exportStaff(
    ...
    const csvContent = await this.staffImportService.exportStaffToCSV({
      department,
      search,
      designation,
      employmentStatus,
  ...
  @RoleAccess.AdminLevel()
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Get CSV template for staff import' })
  @ApiResponse({
    status: 200,
  ...
  async getImportTemplate(@Res() res: Response) {
    const csvContent = this.staffImportService.generateImportTemplate();
